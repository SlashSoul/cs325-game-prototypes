...
BasicGame.LevelFourteen = function(game) {
...
BasicGame.LevelFourteen.prototype = {
  create: function() {
    ...
    this.add.text(16, 16, 'Level 14', {font: '24px Verdana', fill: '#9999FF'});
