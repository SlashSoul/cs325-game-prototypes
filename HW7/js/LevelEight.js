...
BasicGame.LevelEight = function(game) {
...
BasicGame.LevelEight.prototype = {
  create: function() {
    ...
    this.add.text(16, 16, 'Level 8', {font: '24px Verdana', fill: '#9999FF'});
    ...
    blocks.create(350, 350, 'block');
    blocks.create(350, 300, 'block');
    blocks.create(350, 250, 'block');
    ...
    blocks.create(400, 200, 'block');
    blocks.create(450, 500, 'block');
    blocks.create(450, 450, 'block');
    blocks.create(450, 400, 'block');
    blocks.create(450, 350, 'block');
    blocks.create(450, 300, 'block');
    blocks.create(450, 250, 'block');
    blocks.create(450, 200, 'block');
    blockCounter = 21;
